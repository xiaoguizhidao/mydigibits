...
/**
 * Blog post links collection
 *
 * @category    EM
 * @package     EM_Blog
 * @author      Emthemes <emthemes.com>
 */
class EM_Blog_Model_Resource_Post_Link_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
     * Product object
     *
    ...
    public function addProductIdFilter()
    {
        if ($this->getProduct() && $this->getProduct()->getId()) {
            $this->addFieldToFilter('post_id',  array('eq' => $this->getProduct()->getId()));
        }
        return $this;
    }
        ...
        foreach ($attributes as $attribute) {
            ...
            $this->getSelect()->joinLeft(
                ...
                $aliasInCondition . '.link_id = main_table.link_id AND '
                    . $aliasInCondition . '.post_link_attribute_id = ' . (int) $attribute['id'],
