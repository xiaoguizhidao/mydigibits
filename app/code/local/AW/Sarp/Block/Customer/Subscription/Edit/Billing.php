...
class AW_Sarp_Block_Customer_Subscription_Edit_Billing extends Mage_Directory_Block_Data
{
    ...
    {
        return $this->__("Subscription Details - Billing Address");
    }
    ...
    {
        return $this->getSubscription()->getOrder()->getBillingAddress();
    }
    ...
    {
        return Mage::getUrl('sarp/customer/save', array('section' => 'billing', 'id' => $this->getRequest()->getParam('id')));
    }
