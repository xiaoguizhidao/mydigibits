...
class AW_Sarp_Model_Product_Type_Virtual_Price extends Mage_Catalog_Model_Product_Type_Price
{
    ...
    protected function _applySpecialPrice($product, $finalPrice)
    {
        if ($product->getAwSarpEnabled() &&
            $product->getTypeInstance()->getDefaultSubscriptionPeriodId() != AW_Sarp_Model_Period::PERIOD_TYPE_NONE
        ) {
            return $finalPrice;
        }
