...
class AW_Sarp_Model_Web_Service_Client_Paypaluk_NVP extends AW_Sarp_Model_Web_Service_Client_Nvp_Abstract
{
    ...
    {
        return array(
            'USER' => Mage::getStoreConfig(self::XML_PATH_USER, $this->_storeId),
            'VENDOR' => Mage::getStoreConfig(self::XML_PATH_VENDOR, $this->_storeId),
            'PARTNER' => Mage::getStoreConfig(self::XML_PATH_PARTNER, $this->_storeId),
            'PWD' => Mage::getStoreConfig(self::XML_PATH_PASSWORD, $this->_storeId)
        );
    }
    ...
    {
        if ($url = Mage::getStoreConfig(self::XML_PATH_URI, $this->_storeId)) {
            if (!Mage::getStoreConfig(self::XML_PATH_IS_SANDBOX, $this->_storeId)) {
                // Mageno 1.3
                return $url;
            }
        }
