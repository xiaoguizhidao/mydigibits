...
class AW_Sarp_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    const XML_PATH_ADVANCED_QTY_ORDERS_TO_PROCESS = 'sarp/advanced/qty_orders_to_process';
    const XML_PATH_ADVANCED_NUMBER_OF_RETRIES = 'sarp/advanced/number_of_retries';
}
